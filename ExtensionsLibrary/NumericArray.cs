...
namespace ExtensionsLibrary
{
    public static class NumericArray
    {
        ...
        public static bool AllDouble(this string[] sender) =>
            sender.All(item => double.TryParse(item, out var _));
        ...
        /// <summary>
        /// Convert all values in array to double array where
        /// non double values will be set to the default value.
        /// </summary>
        /// <param name="sender">string array</param>
        ...
        public static int[] GetNonDoubleIndexes(this string[] sender)
        {
            return sender.Select(
                ...
                .ToArray()
                .Where(item => item.IsDouble == false)
                .Select(item => item.Index)
                .ToArray();
        }
        ...
        /// <param name="sender">string array</param>
        /// <returns>
        /// All valid elements that are decimal discarding non decimal values
        /// </returns>
        ...
        /// <summary>
        /// Convert all values in array to decimal array
        /// where non decimal values will be set to the default value.
        /// </summary>
        /// <param name="sender">string array</param>
        ...
        /// <param name="sender">string array</param>
        /// <returns>
        /// All valid elements that are float discarding non float values
        /// </returns>
        ...
        /// <summary>
        /// Convert all values in array to float array where non
        /// float values will be set to the default value.
        /// </summary>
        /// <param name="sender">string array</param>
        /// <returns>
        /// All elements in array as float
        /// </returns>
        ...
        /// </summary>
        /// <param name="sender"></param>
        /// <returns>If all values are type short</returns>
        ...
        /// <summary>
        /// Convert all values in array to short array where
        /// non short values will be set to the default value.
        /// </summary>
        /// <param name="sender">string array</param>
        /// <returns>
        /// All elements in array as short
        /// </returns>
        ...
        /// </summary>
        /// <param name="sender"></param>
        /// <returns>All non-short values</returns>
